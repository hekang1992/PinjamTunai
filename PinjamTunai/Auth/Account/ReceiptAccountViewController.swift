//
//  ReceiptAccountViewController.swift
//  PinjamTunai
//
...
class ReceiptAccountViewController: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        headView.nameLabel.text = LanguageManager.localizedString(for: "Receipt Account")
...
extension ReceiptAccountViewController {
    ...
    private func tracksegmesageInfo() async {
        Task {
            do {
